   ...
   return(
      <nav className={style.menu}>
         <div className={style.top}>
            ...
            >
               <Link href={'https://app.mktzap.com.br/login'} target='_blank' className={style.link}>
            ...
            >
               <Link href={'https://sendfirst.bubbleapps.io/'} target='_blank' className={style.link}>
            ...
            >
               <Link href={'https://web.whatsapp.com/'} target='_blank' className={style.link}>
