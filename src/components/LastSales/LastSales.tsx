...
import {
  ...
  MdAttachMoney,
  MdCompareArrows,
} from 'react-icons/md' // Corrigido aqui
                ...
                {infos?.SD2.map((el, i) => (
                  <li key={i}>
                    ...
                    <div className={style.div_values}>
                      <p className={style.value_list}>
                        +{' '}
                        {el.D2_TOTAL.toLocaleString('pt-BR', {
                          style: 'currency',
                          currency: 'BRL',
                        })}
                      </p>
                      {infos.SD1.map((sd1, index) =>
                        sd1.D1_DTDIGIT == el.D2_EMISSAO ? (
                          <p
                            key={index}
                            className={style.value_list_devolution}
                          >
                            -{' '}
                            {sd1.D1_TOTAL.toLocaleString('pt-BR', {
                              style: 'currency',
                              currency: 'BRL',
                            })}
                          </p>
            ...
            <div className={style.seler_right}>
              ...
              <div className={style.infos}>
                <div className={style.info}>
                  ...
                  <p className={style.value}>
                    {infos?.MES.SD2_TOTAL
                      ? infos.MES.SD2_TOTAL.toLocaleString('pt-BR', {
                          style: 'currency',
                          currency: 'BRL',
                        })
                      : 'R$ 0,00'}
                ...
                <div className={style.divIcon}>
                  <MdAttachMoney
                    className={`${style.dayInfo_icon} ${style.sale}`}
                  />
                </div>
              </div>
              <div className={style.infos}>
                <div className={style.info}>
                  ...
                  <p className={style.value}>
                    {infos?.MES.MARGEM_MES
                      ? infos.MES.MARGEM_MES.toFixed(2)
                      : 0}
                    %
                  </p>
                </div>
              ...
              <div className={style.infos}>
                <div className={style.info}>
                  ...
                  <p className={style.value}>
                    {infos?.MES.SD1_TOTAL
                      ? infos.MES.SD1_TOTAL.toLocaleString('pt-BR', {
                          style: 'currency',
                          currency: 'BRL',
                        })
                      : 'R$ 0,00'}
